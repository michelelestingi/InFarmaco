...
$("div.ui-header > h1#itemtitle").text(str).css({"font-size" : "14px", "margin" : ".6em 0px .8em"});
}
...
$("div.ui-header > h1#itemtitle").text("Patient Information Leaflet").css({"font-size" : "16px", "margin" : ".6em 0px .8em"});
}
});
...
$(".ui-header").css("top", "0");
if($( ".ui-page" ).is('#info, #comment, #leaflet')){
$(".navigation").animate({"left": "-220px"}, "fast", function(){ $(this).hide() });
}
});
...
$(".navigation").animate({"left": "-205px"}, "slow" );
});
...
$(".ui-body:has(#sideefetctsfiels)").css("height", "230px");
$("input[type='radio']#radio-choice-1, input[type='radio']#radio-choice-2").bind( "change", function(event, ui) {
$(".ui-body:has(#sideefetctsfiels)").animate({"height": "230px"}, "slow", function(){ $("#sideefetctsfiels").hide(); });
});
$("input[type='radio']#radio-choice-3").bind( "change", function(event, ui) {
$("#sideefetctsfiels").show();
$(".ui-body:has(#sideefetctsfiels)").animate({"height": "960px"}, "slow");
});
});
